...
**Emberveil 副本掉落浏览器**（AtlasLoot 式）· 适用于 Emberveil 客户端（WoW 1.12.1 模拟 / Lua 5.1 API）· 当前版本 0.2.1

![EmberLoot](docs/preview.png)

## 功能

- **副本 → 首领 → 掉落表**三级浏览：内置 **25 个已开放副本/战场**（血色、死亡矿井、黑石深渊、厄运之槌、玛拉顿、阿塔哈卡、祖尔法拉克、黑上/黑下、通灵学院、斯坦索姆、熔火之心、奥妮克希亚……随官方数据库持续更新）、190 个首领/精英 + 22 个区域小怪掉落池、**4567 件物品 / 24551 条掉落记录**（中英双名）
...
1. 下载 `EmberLoot-0.2.1.zip` 并解压
2. 把 `EmberLoot` 整个文件夹放进 `...\Emberveil\live\Azeroth\Interface\AddOns\`
3. 重登游戏，聊天栏出现 `EmberLoot 0.2.1 — N 个副本 / M 件物品` 即成功
